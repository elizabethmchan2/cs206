...
public class Place implements Comparable<Place>{
	...
	private int males; 
	//constructors 
	public Place(String _zip, String _town, String _state, int _total, int _males, int _females) {
		this.Azip.add(_zip); 
		this.town = _town; 
		this.state = _state;
...
//	} //getZip()
	...
	public void update(String z, int total, int f, int m) {
		Azip.add(z); 
	...
	public String toString() {
		return this.Azip+ " (Total Population: " + this.totalPopulation+ " Female: " + this.females + " Male: " + this.males+ ")"; 
	} //toString() 
